...
light neutral background with subtle world-map watermark, white cards
with soft borders and shadows, muted teal accent palette, transparent
charts with pale grid lines. Text in dark slate with teal headings.
...
# ---------------------------------------------------------------- PALETTE
# Backgrounds
BG_BASE       = "#F0F3F5"       # app background - light warm grey
BG_GRADIENT_1 = "#EEF2F4"       # gradient top
BG_GRADIENT_2 = "#F6F8FA"       # gradient bottom
CARD_BG       = "#FFFFFF"
CARD_BORDER   = "#D6DDE3"
CARD_SHADOW   = "0 1px 3px rgba(15, 23, 42, 0.06), 0 1px 2px rgba(15, 23, 42, 0.04)"

# Teal spectrum (muted corporate teal)
TEAL_DARK     = "#3D5F6E"       # primary bars, metric boxes
TEAL_MID      = "#4A6E7E"       # hover / secondary
TEAL_LIGHT    = "#7BA8B8"       # labels, secondary accents
TEAL_PALE     = "#A8C4CE"       # tertiary / muted
TEAL_SOFT     = "#DCE8EC"       # panel tint

# Text
TEXT_PRIMARY  = "#2C3E50"       # headings, main numbers
TEXT_MUTED    = "#6B7A8A"       # labels, subtitles
TEXT_ALERT    = "#A93226"       # red for warnings/negative values
TEXT_LIGHT    = "#5A6B7A"
