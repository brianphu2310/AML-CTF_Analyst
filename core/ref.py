...
ANALYSTS = [
    {"name": "Sofia Marchetti", "short": "Marchetti, S.", "role": "Compliance Manager (MLRO)", "branch": "Richmond", "start": "2022-03-01", "capacity": 4, "avg_hours": 2.6},
...
MLRO_NAME = "Sofia Marchetti"      # Money Laundering Reporting Officer — decides whether a suspicion is formed
FIRM_NAME = "D'Agostino Legal (fictional)"
